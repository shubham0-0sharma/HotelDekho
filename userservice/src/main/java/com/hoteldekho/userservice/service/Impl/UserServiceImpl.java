...
//creating header with entity
        ...
        ResponseEntity<Rating> response = restTemplate.exchange(CREATE_RATING_URL, HttpMethod.POST,entity,Rating.class);
    ...
    public User getUser(String userId) {
        User user = userRepository.findById(userId).orElseThrow(() -> new NoResourceFoundException("User with given id not found on Server: " + userId));
